...
/** Light: 디자인 시안 — 네이비 포인트, 밝은 캔버스, 부드러운 대비 */
const light: ThemeColors = {
  ...
  tabBarBorder: '#e8ecf4',
  headerBg: '#f5f6f8',
  headerGradientStart: '#1a2d4a',
  headerGradientEnd: '#1a2d4a',
  headerTint: '#1c2434',
  chipInactiveBg: '#f3f5f9',
  chipActiveBg: '#1a2d4a',
  chipInactiveBorder: '#e4e8f0',
  chipActiveBorder: '#1a2d4a',
  chipTextInactive: '#1c2434',
  chipTextActive: '#ffffff',
  catPill: '#e8ecf4',
  gridActiveBg: '#e8edf5',
  gridActiveBorder: '#1a2d4a',
  gridTextActive: '#1a2d4a',
  pillBg: '#eef1f6',
  pillActiveBg: '#e8edf5',
  pillActiveBorder: '#c5d0e6',
  pillText: '#5c6578',
  pillTextActive: '#1a2d4a',
  choiceBg: '#ffffff',
  choiceActiveBg: '#e8edf5',
  choiceActiveBorder: '#1a2d4a',
  choiceTextActive: '#1a2d4a',
  accentBlue: '#3d5a80',
  accentCta: '#1a2d4a',
  keyFindingBg: '#4F46E5',
  offlineBg: '#FFF3CD',
  ...
  emptyIcon: '#b4bcc9',
  starColor: '#CA8A04',
  categoryLabelBg: '#eef1f6',
  success: '#2E7D32',
};

/** Dark: OLED 친화 배경, 딥 네이비 헤더, 소프트 블루 액센트 */
const dark: ThemeColors = {
  ...
  tabBarBorder: '#2A3548',
  headerBg: '#1A2F4A',
  headerGradientStart: '#0F1F35',
  headerGradientEnd: '#1A2F4A',
  headerTint: '#E2E8F0',
  chipInactiveBg: '#232f42',
  chipActiveBg: '#3B82F6',
  chipInactiveBorder: '#334155',
  chipActiveBorder: '#3B82F6',
  chipTextInactive: '#E2E8F0',
  chipTextActive: '#FFFFFF',
  catPill: '#232f42',
  gridActiveBg: '#1e3a5f',
  ...
  choiceBg: '#232f42',
  choiceActiveBg: '#1e3a5f',
  choiceActiveBorder: '#3B82F6',
