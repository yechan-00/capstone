...
function QuickInputSheet({
  visible, onClose, quickPresets, quickEditMode, setQuickEditMode,
  handleDeletePreset, setEditingPreset, setShowPresetModal,
  colors, width, onSaved, account, createExpense, handleAddPreset,
}: any) {
  const insets = useSafeAreaInsets();

  // 2단계: 선택된 프리셋 + 이유/기분/태그 입력
  ...
  const [innerShowPresetModal, setInnerShowPresetModal] = useState(false);
  const [innerEditingPreset, setInnerEditingPreset] = useState<QuickPreset | null>(null);
  ...
  return (
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
          ...
          <>
            <View style={styles.quickHeader}>
              ...
              <View style={{ flexDirection: 'row', gap: 6 }}>
                ...
                <Pressable
                  ...
                  onPress={() => { setQuickEditMode(null); setInnerEditingPreset(null); setInnerShowPresetModal(true); }}
                >
            ...
            {quickPresets.length === 0 ? (
              <Pressable
                ...
                onPress={() => { setEditingPreset(null); setShowPresetModal(true); }}
              >
                  ...
                  <Pressable
                    ...
                    onPress={() => {
                      if (quickEditMode === 'edit') {
                        setInnerEditingPreset(preset);
                        setInnerShowPresetModal(true);
      ...
      <QuickPresetModal
        ...
        onClose={() => { setInnerShowPresetModal(false); setInnerEditingPreset(null); }}
          ...
          options={{
            ...
            tabBarButton: () => (
              <AddTabButton
                ...
                onLongPress={() => { setQuickEditMode(null); setShowQuickSheet(true); }}
